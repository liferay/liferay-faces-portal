...
public class TestPages {
	...
	static {
		...
		BRIDGE_DEMO_PAGES.add(new PortalPage("jsf-cdi-applicant", new Portlet("1", "com.liferay.faces.demo.jsf.cdi.applicant.portlet")));
		BRIDGE_DEMO_PAGES.add(new PortalPage("jsf-flows", new Portlet("1", "com.liferay.faces.demo.jsf.flows.portlet")));
		BRIDGE_DEMO_PAGES.add(new PortalPage("jsf-html5-applicant", new Portlet("1", "com.liferay.faces.demo.jsf.html5.applicant.portlet")));
		BRIDGE_DEMO_PAGES.add(new PortalPage("jsf-spring-applicant", new Portlet("1", "com.liferay.faces.demo.jsf.spring.applicant.portlet")));
		BRIDGE_DEMO_PAGES.add(new PortalPage("jsf-jsp-applicant", new Portlet("1", "com.liferay.faces.demo.jsf.jsp.applicant.portlet")));
		BRIDGE_DEMO_PAGES.add(new PortalPage("jsf-pdf", new Portlet("1", "com.liferay.faces.demo.jsf.export.pdf.portlet", false)));
		...
		BRIDGE_DEMO_PAGES.add(new PortalPage("alloy-applicant", new Portlet("1", "com.liferay.faces.demo.alloy.applicant.portlet")));
		BRIDGE_DEMO_PAGES.add(new PortalPage("primefaces-applicant", new Portlet("1", "com.liferay.faces.demo.primefaces.applicant.portlet")));
		BRIDGE_DEMO_PAGES.add(new PortalPage("richfaces-applicant", new Portlet("1", "com.liferay.faces.demo.richfaces.applicant.portlet")));
	}

	static {
		BRIDGE_ISSUE_PAGES = new ArrayList<PortalPage>();
		BRIDGE_ISSUE_PAGES.add(new PortalPage("FACES-224", new Portlet("1", "com.liferay.faces.issue.224.portlet", false)));
		BRIDGE_ISSUE_PAGES.add(new PortalPage("FACES-1470", new Portlet("1", "com.liferay.faces.issue.1470.portlet", false)));
		BRIDGE_ISSUE_PAGES.add(new PortalPage("FACES-1478", new Portlet("1", "com.liferay.faces.issue.1478.portlet", false)));
		BRIDGE_ISSUE_PAGES.add(new PortalPage("FACES-1618", new Portlet("1", "com.liferay.faces.issue.1618.portlet", false)));
		BRIDGE_ISSUE_PAGES.add(new PortalPage("FACES-1635", new Portlet("1", "com.liferay.faces.demo.jsf.applicant.portlet"),
	...
	static {
		...
		LSV_ISSUE_PAGES.add(new PortalPage("LSV-71-Resource-Handler", new Portlet("3", "com.liferay.faces.lsv.71.portlet", false)));
	...
	static {
		...
		PortalPage portalPage = new PortalPage("jsf-showcase", new Portlet("1", "com.liferay.faces.demo.jsf.showcase.portlet", false));
		portalPage.setLayoutTemplateId("1_column");
		GUEST_PAGES.add(portalPage);
		portalPage = new PortalPage("alloy-showcase", new Portlet("1", "com.liferay.faces.demo.alloy.showcase.portlet", false));
		portalPage.setLayoutTemplateId("1_column");
		GUEST_PAGES.add(portalPage);
		portalPage = new PortalPage("metal-showcase", new Portlet("1", "com.liferay.faces.demo.metal.showcase.portlet", false));
		portalPage.setLayoutTemplateId("1_column");
		GUEST_PAGES.add(portalPage);
