...
public class PrimefacesUsersPortletTest extends TesterBase {
	...
	private static final String portletTitleTextXpath = "//span[text()=' PrimeFaces Users ']";
	...
	private static final String primefacesUsersLinkTestSetupXpath = "//a[contains(@href,'primefacesusersportlet')]";
	...
	@FindBy(xpath = primefacesUsersLinkTestSetupXpath)
	private WebElement primefacesUsersLinkTestSetup;
	...
	public void usersListView() throws Exception {
		...
		primefacesUsersLinkTestSetup.click();
