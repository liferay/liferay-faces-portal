...
public class Primefaces5UsersPortletTest extends TesterBase {

	// elements for Primefaces5Users
	private static final String portletTitleTextXpath = "//span[text()=' PrimeFaces5 Users ']";
	...
	private static final String primefaces5UsersLinkTestSetupXpath = "//a[contains(@href,'primefaces5usersportlet')]";
	...
	@FindBy(xpath = primefaces5UsersLinkTestSetupXpath)
	private WebElement primefaces5UsersLinkTestSetup;
	...
	public void usersListView() throws Exception {
		...
		primefaces5UsersLinkTestSetup.click();
	...
	public void specificUserView() throws Exception {
		...
		logger.log(Level.INFO, "isThere(browser, fileEntryXpath) = " + isThere(browser, fileEntryXpath));
		assertTrue("The File Entry should be displayed on the page at this point but it is not.",
			isThere(browser, fileEntryXpath));
