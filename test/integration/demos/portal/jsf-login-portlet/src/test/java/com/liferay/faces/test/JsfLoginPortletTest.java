...
public class JsfLoginPortletTest extends TesterBase {

	private static final Logger logger = Logger.getLogger(JsfLoginPortletTest.class.getName());
	...
	static final String url = baseUrl + "/web/guest/jsf-sign-in";
	...
	public void signIn() throws Exception {
		...
		signInButton.click();
		logger.log(Level.INFO, "starting to wait ...");
		waitForElement(browser, "//div[contains(text(),'You are signed in as')]");
